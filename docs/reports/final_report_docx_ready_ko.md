...
사용성 평가도 아직 최종 수치가 없는 영역이다. 다만 현재는 3개 task 기반 pilot usability protocol과 post-task Google Form 문항이 정의되어 있으므로, 최종 보고서에서는 “user study not yet complete”라고만 쓰기보다 “pilot protocol defined; aggregate outcomes pending”으로 표현하는 것이 더 정확하다.
