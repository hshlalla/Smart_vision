...
[4] Oquab, M., et al. (2024) 'DINOv2: Learning Robust Visual Features without Supervision', *Transactions on Machine Learning Research*.

[5] Radford, A., Kim, J.W., Hallacy, C., et al. (2021) 'Learning Transferable Visual Models From Natural Language Supervision', *Proceedings of the 38th International Conference on Machine Learning (ICML)*.

[6] eBay Inc. (2017) *Find It On eBay: Using Pictures Instead of Words*. Available at: https://innovation.ebayinc.com/stories/find-it-on-ebay-using-pictures-instead-of-words/ (Accessed: 23 March 2026).

[7] eBay Inc. (2024) *eBay’s Magical Listing Tool Wins AI Breakthrough Award for ‘Best Overall Generative AI Solution’*. Available at: https://innovation.ebayinc.com/stories/ebays-magical-listing-tool-wins-ai-breakthrough-award-for-best-overall-generative-ai-solution/ (Accessed: 23 March 2026).

[8] Milvus Documentation (n.d.) *Multi-Vector Hybrid Search*. Available at: https://milvus.io/docs/multi-vector-search.md (Accessed: 23 March 2026).

[9] PaddlePaddle (n.d.) *PaddleOCR Documentation*. Available at: https://github.com/PaddlePaddle/PaddleOCR (Accessed: 23 March 2026).
